...
// Placeholder en base64 para carga instantánea
        ...
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-18">
          ...
          <div className="lg:w-[37.5%]">
              ...
              product.precio_base > product.precio_oferta ? (
                <>
                  ...
                  <p className="text-xs text-green-600 mt-1">
                    Ahorras{" "}
                    {formatPrice(product.precio_base - product.precio_oferta)}
                  </p>
                </>
              ) : (
                <span className="text-3xl font-bold text-gray-900">
            ...
            {Object.entries(variantGroups).map(([atributo, valores]) => (
              <div key={atributo} className="mb-5">
                <div className="flex items-center gap-2 mb-2">
                  <p className="text-sm font-medium text-gray-700 capitalize">
                    {atributo}
                  </p>
                  <Tooltip content={`Selecciona el ${atributo} que prefieras`}>
                    <HelpCircle
                      size={14}
                  ...
                  {valores.map((val) => {
                    ...
                    return (
                      <button
                        ...
                        className={`
                          px-4 py-1.5 text-sm border rounded-md transition-all duration-150
                          ${
                            isSelected
                              ? "border-gray-800 bg-gray-50 text-gray-900 shadow-sm"
                              : "border-gray-200 text-gray-600 hover:border-gray-400 hover:bg-gray-50"
                          }
                          ${outOfStock ? "opacity-50 cursor-not-allowed bg-gray-100" : ""}
                          ${
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-6">
              <div className="flex items-center border border-gray-200 rounded-md overflow-hidden">
                ...
                <button
                  onClick={() =>
                    setQuantity(
                      Math.min(product.stock_total || 99, quantity + 1),
                    )
                  }
              ...
              >
                ...
                {product.stock_total === 0 ? "Sin stock" : "Agregar al Carro"}
              </Button>
